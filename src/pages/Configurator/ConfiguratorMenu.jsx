    ...
    <div className="menu">
      ...
      <div className="sections">
            ...
            {(isMobile || showPresets) && (
              <div className="section-list-wrapper">
                <div className="section-list text-list">
                  ...
                  <div
                    className={`text-select ${
                      currentPreset === presets.modernAlcantara ? "active" : ""
                    }`}
          ...
          <div className="section">
            ...
            <div className="section-list">
              ...
              <div
                ...
                onClick={() => {
                  dispatch({ type: "SET_ARMREST_TYPE", payload: "cushioned" });
                  setCurrentPreset(null);
                }}
              >
                Cushioned
        ...
        {(!isMobile || currentStage === 3) && (
          <div className="section">
            <h3>Cushion Color</h3>
            <div className="section-list scroll-list">
          ...
          <div className="section">
            ...
            <div className="section-list">
              <div
                ...
                onClick={() => {
                  dispatch({ type: "SET_BODY_TEXTURE", payload: "aluminum" });
                  setCurrentPreset(null);
                }}
              >
              ...
              >
                <div className="img-select-indicator">
                  <div className="img-select-dot">
                    <img src="/assets/carbon-fiber.jpg" alt="Carbon Fiber" />
                  </div>
                </div>
